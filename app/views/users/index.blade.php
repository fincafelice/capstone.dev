...
<div class="container">
 ...
 <div class="col-md-4">  <!-- begin search form block -->
  ...
  {{ Form::open(array('action' => array('SalesController@index'), 'id' => 'ajax-form', 'class'=>'form width88', 'role'=>'search')) }}    

  <p class="text-info"><strong>Tip:</strong> Try Searching For Specific Items</p>
		...
		$('#results-list').append(
		  '<div class="row">' +
			...
			'<div class="zero-margin-left blog-block">' +
			  '<div class="col-md-6">' +
				'<a href="http://capstone.dev/sales/' + this.id + '"><h3>' + this.sale_name + '</a> | ' + '<a href="http://capstone.dev/users/' + this.user.id + '">' + this.user.username + '</h3></a>' +
				'</div>' + 
				'</div>'
		  );
		var address = this.sale.address;
		// console.log(address);
